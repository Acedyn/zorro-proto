...
from protos.config import user_config_pb2 as protos_dot_config_dot_user__config__pb2
from protos.config import plugin_config_pb2 as protos_dot_config_dot_plugin__config__pb2
