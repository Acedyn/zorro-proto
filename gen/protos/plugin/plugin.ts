...
export interface Plugin {
  ...
  repository: FileSystemSettings | undefined;
}
...
export const Plugin = {
  encode(message: Plugin, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.repository !== undefined) {
      FileSystemSettings.encode(message.repository, writer.uint32(74).fork()).ldelim();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 9:
          ...
          message.repository = FileSystemSettings.decode(reader, reader.uint32());
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): Plugin {
    return {
      ...
      processors: globalThis.Array.isArray(object?.processors)
        ...
        : [],
      repository: isSet(object.repository) ? FileSystemSettings.fromJSON(object.repository) : undefined,
    };
  },
  ...
  toJSON(message: Plugin): unknown {
    ...
    if (message.repository !== undefined) {
      obj.repository = FileSystemSettings.toJSON(message.repository);
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Plugin>, I>>(object: I): Plugin {
    ...
    message.repository = (object.repository !== undefined && object.repository !== null)
      ? FileSystemSettings.fromPartial(object.repository)
      : undefined;
    return message;
  },
};
