...
class Processor(_message.Message):
    __slots__ = ["id", "name", "version", "label", "paths", "subsets", "start_program_template", "start_processor_template", "metadata", "stdout", "stderr"]
