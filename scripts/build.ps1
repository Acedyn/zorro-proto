...
protoc --go_out=gen --go_opt=paths=source_relative --go-grpc_out=gen --go-grpc_opt=paths=source_relative ./protos/context/*.proto
...
protoc --go_out=gen --go_opt=paths=source_relative --go-grpc_out=gen --go-grpc_opt=paths=source_relative ./protos/processor/*.proto
...
python -m grpc_tools.protoc -I. --python_out=gen --pyi_out=gen --grpc_python_out=gen ./protos/context/*.proto
...
python -m grpc_tools.protoc -I. --python_out=gen --pyi_out=gen --grpc_python_out=gen ./protos/processor/*.proto
...
protoc --plugin=protoc-gen-ts_proto.cmd --ts_proto_out=gen .\protos\context\*.proto
...
protoc --plugin=protoc-gen-ts_proto.cmd --ts_proto_out=gen .\protos\processor\*.proto
