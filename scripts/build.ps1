...
protoc --go_out=gen --go_opt=paths=source_relative --go-grpc_out=gen --go-grpc_opt=paths=source_relative ./protos/network/*.proto
...
protoc --plugin=protoc-gen-ts_proto.cmd --ts_proto_out=gen .\protos\network\*.proto
